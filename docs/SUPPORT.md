...
For the GCWeb/Jekyll setup to function a `_config.yml` file must saved at the repositories root. Examples: [GCWeb _config.yml](https://github.com/wet-boew/gcweb-jekyll/blob/master/_config.yml), [core-prototype _config.yml](https://github.com/proto-cra/core-prototype/blob/main/_config.yml)
...
## Site [_config.yml](https://github.com/proto-cra/gst-hst-business/blob/main/_config.yml) file options
...
## Additional site [_config.yml](https://github.com/proto-cra/gst-hst-business/blob/main/_config.yml) file options
...
## Custom YAML site [_config.yml](https://github.com/proto-cra/gst-hst-business/blob/main/_config.yml) file options
